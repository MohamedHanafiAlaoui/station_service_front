...
export class StationService {
  ...
  countActiveStations(): Observable<number> {
    return this.http.get<number>(`${Api.STATIONS}/count/active`);
  }
  countInactiveStations(): Observable<number> {
    return this.http.get<number>(`${Api.STATIONS}/count/inactive`);
  }
}